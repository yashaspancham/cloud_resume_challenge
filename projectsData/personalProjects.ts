...
export const projects: PersonalProjectCardPropsT[] = [{
    ...
    docUrl: "https://medium.com/@yashaspancham/project-z-architecture-62fa39b435b3?postPublishedType=initial",
    catagory: [Catagory.All, Catagory.Cloud, Catagory.DevOps, Catagory.Fullstack],
},
{
    id: 7,
